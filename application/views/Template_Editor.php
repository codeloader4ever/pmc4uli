...
<div class="span2 main-menu-span">
			  <div class="well nav-collapse sidebar-nav">
				<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a class="ajax-link" href="<?php echo base_url(); ?>index.php/Admin/TambahPengguna">
                                                        <i class="icon-home"></i>
                                                        <span class="hidden-tablet"> Beranda</span>
                                                    </a>
                                                </li>
						<li><a class="ajax-link" href="<?php echo base_url(); ?>index.php/Admin/TambahPengguna">
                                                        <i class="icon-file"></i>
                                                        <span class="hidden-tablet"> My Project</span>
                                                    </a>
                                                </li>
						<li><a class="ajax-link" href="<?php echo base_url(); ?>index.php/Admin/TambahPengguna">
                                                        <i class="icon-th-list"></i>
                                                        <span class="hidden-tablet"> File Publikasi</span>
                                                    </a>
                                                </li>
                                                <li><a class="ajax-link" href="<?php echo base_url(); ?>index.php/Admin/TambahPengguna">
                                                        <i class="icon-book"></i>
                                                        <span class="hidden-tablet"> Artikel</span>
                                                    </a>
                                                </li>
                                </ul>
                          </div>
