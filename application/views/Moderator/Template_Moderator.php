...
<head>
	...
	<link href='<?php echo base_url();?>/Asset/css/uploadify.css' rel='stylesheet'>
        ...
        <link href="<?php echo base_url();?>/Asset/css/flick/jquery-ui-1.10.0.custom.css" rel="stylesheet">
        <link href="<?php echo base_url();?>/Asset/css/flick/jquery-ui-1.10.0.custom.min.css" rel="stylesheet">
...
<script src="<?php echo base_url();?>/Asset/development-bundle/jquery-1.9.0.js"></script>
<script src="<?php echo base_url();?>/Asset/development-bundle/ui/jquery.ui.core.js"></script>
<script src="<?php echo base_url();?>/Asset/development-bundle/ui/jquery.ui.widget.js"></script>
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="<?php echo base_url();?>/Asset/index.html"> <img alt="Charisma Logo" src="<?php echo base_url();?>/Asset/img/logoq.png" /> <span> <strong>Website Editor</strong></span></a>
				...
				<a href="<?php echo base_url() ?>index.php/Utama" target="_blank" class="btn">View</a>
                                </div>
                                
                               <div class="btn-group pull-right" >
					<a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
						<i class="icon-user"></i><span class="hidden-phone"> Moderator</span>
						<span class="caret"></span>
					</a>
					<ul class="dropdown-menu">
                                            <li><a href="<?php echo base_url() ?>index.php/Moderator/UbahProfil_Pribadi_Moderator">Ubah Akun</a></li>
                                            <li><a href="<?php echo base_url() ?>index.php/Moderator/Ubah_Password_Moderator">Ubah Password</a></li>
                                            <li class="divider"></li>
                                            <li><a href="<?php echo base_url() ?>index.php/Moderator/Logout">Keluar</a></li>
					</ul>
			  </div>
				<!-- user dropdown ends -->
			...
			<div class="span2 main-menu-span">
				<div class="well nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
                                                    <a class="ajax-link" href="<?php echo base_url(); ?>index.php/Admin">
                                                        <i class="icon-home"></i>
                                                        <span class="hidden-tablet"> Beranda
                                                        </span>
                                                    </a>
                                                </li>
						<li class="nav-header hidden-tablet">Pengguna</li>
						<li>
                                                    <a class="ajax-link" href="<?php echo base_url(); ?>index.php/Moderator/Daftar_Pengguna">
                                                        <i class="icon-list"></i>
                                                        <span class="hidden-tablet"> Daftar Pengguna
                                                        </span>
                                                    </a>
                                                </li>
						<li class="nav-header hidden-tablet">Kategori Artikel</li>
						<li>
                                                    <a class="ajax-link" href="<?php echo base_url(); ?>index.php/Moderator/TambahKategoriArtikel">
                                               ...
                                               <li>
                                                   <a class="ajax-link" href="<?php echo base_url(); ?>index.php/Moderator/Daftar_KategoriArtikel">
                                                       <i class="icon-list"></i>
                                                       Daftar Kategori Artikel
                                                   </a>
                                               </li>
						
                                               <li class="nav-header hidden-tablet">Artikel</li>
						<li>
                                                    <a class="ajax-link" href="<?php echo base_url(); ?>index.php/Moderator/TambahArtikel">
                                                        <i class="icon-book"></i>
                                                        Tambah Artikel
                                                    </a>
                                                </li>
						<li>
                                                    <a class="ajax-link" href="<?php echo base_url(); ?>index.php/Moderator/Daftar_Artikel">
                                                        <i class="icon-list"></i>
                                                        Daftar Artikel
                                                    </a>
                                                </li>
                                                 <li class="nav-header hidden-tablet">Pesan</li>
                                                <li>
                                                    <a class="ajax-link" href="<?php echo base_url(); ?>index.php/Moderator/Daftar_Pesan">
                                                        <i class="icon-list"></i>
                                                        Daftar Pesan
                                                    </a>
                                                </li>
						...
						<li>
                                                    <a class="ajax-link" href="<?php //echo base_url(); ?>index.php/Moderator/TambahLevel">
                                                        <i class="icon-star"></i>
						...
						<li>
                                                    <a class="ajax-link" href="<?php //echo base_url(); ?>index.php/Moderator/Daftar_Level">
                                                        <i class="icon-list"></i>
...
<!-- CONTENT-->                                      
		...
		<div>
		<footer>
			<p class="pull-left">&copy; <a href="#">Ulfah Athiqoh</a> 417DRI</p>
		</footer>
		</div>
		<!--/.fluid-container-->
...
<?php // echo $this->session->userdata('id_pengguna'); ?>		
</body>
</html>
