<div class="box span12">
    ...
    <div class="box-content">
      <form class="form-search" id="form_pencarian" name="form_pencarian" method="post" action="<?=base_url();?>index.php/Moderator/Daftar_Pesan">
            <h4>Pencarian</h4>
            <input type="text" class="input-medium search-query" style="width: 20%" id="isi" name="isi">
    <button type="submit" class="btn btn-primary">Cari</button>
    <a href="<?php echo base_url();?>index.php/Moderator/DaftarPesan" class="btn btn-primary"">Refresh</a>
    </form>
	...
	<tr>
		...
		<tr>
			...
			<?php
                        ...
                        <td class="center">
                        <a class="btn btn-danger" href='<?php echo base_url();?>index.php/Moderator/HapusPesan/<?php echo $row->id_pesan;?>' onClick='return confirm("Anda yakin ingin menghapus data ini?")' title='Hapus'>
