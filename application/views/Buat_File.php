    <div class="box span12">
      ...
      <div class="box-content">
          <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>index.php/Utama/Buat_File/<?php echo $this->uri->segment(3); ?>/?file=<?php echo $this->input->get('file'); ?>">
    <?php
