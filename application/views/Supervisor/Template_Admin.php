	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<h1><a class="navbar" href="index.html"><img src="<?php echo base_url();?>/Asset/img/logo.png" /> <span> <strong><font size ="20">ePAMCO</font></strong></span></a></h1>
				...
				<!-- user dropdown starts -->
					...
					<a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
						<i class="icon-user"></i><span class="hidden-phone"><font size="4">Admin</font></span>
						<span class="caret"></span>
					</a>
					<ul class="dropdown-menu">
                                            <!--<li><a href="<?php echo base_url() ?>index.php/Admin/UbahProfil_Pribadi_Admin">Change Account</a></li>-->
                                            <li><a href="<?php echo base_url() ?>index.php/Admin/Ubah_Password_Admin">Change Password</a></li>
                                            <li class="divider"></li>
			...
			<div class="span2 main-menu-span">
				<div class="well nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
                                                    <a class="ajax-link" href="<?php echo base_url(); ?>index.php/Admin/Daftar_Pengguna">
                                                        <i class="icon-user"></i>
                                                        <span class="hidden-tablet"> Web User
                                                        </span>
                                                    </a>
                                                </li>
												
						<li>
                                                    <a class="ajax-link" href="<?php echo base_url(); ?>index.php/Admin/Daftar_Supervisor">
                                                        <i class="icon-user"></i>
                                                        <span class="hidden-tablet"> Operator
                                                        </span>
                                                    </a>
                                                </li>
						<li class="nav-header hidden-tablet">Product</li>
						<li>
                                                    <a class="ajax-link" href="<?php echo base_url(); ?>index.php/Admin/TambahProduct">
                                               ...
                                               <li>
                                                   <a class="ajax-link" href="<?php echo base_url(); ?>index.php/Admin/Daftar_Product">
                                                       <i class="icon-list"></i>
                                                       Product List
                                                   </a>
                                               </li>
						
                                               <li class="nav-header hidden-tablet">Export to Excel</li>
						<li>
                                                    <a class="ajax-link" href="<?php echo base_url(); ?>index.php/Admin/Daftar_MC_Number">
                                                        <i class="icon-file"></i>
                                                        MC Number
                                                    </a>
                                                </li>
...
<!-- CONTENT-->                                      
		...
		<div>
		<footer>
			<p class="pull-left">&copy; <a href="#">Copyright</a> 2017</p>
		</footer>
		</div>
		<!--/.fluid-container-->
