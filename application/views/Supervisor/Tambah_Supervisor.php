    <div class="box span12">
      <div class="box-header well" data-original-title="data-original-title">
        <h2><i class="icon-user"></i> Add New Supervisor
          <script src="js/jquery-ui-1.8.21.custom.min.js"></script>
        </h2>
        
      </div>
      <div class="box-content">
        <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>index.php/Admin/TambahSupervisor">
 <?php
 ...
 ?>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" id="inputSuccess" name="id_spv">
              </div>
            </div>
            <div class="control-group">
            ...
            <div class="form-actions"> 
              ...
              <a href="<?php echo base_url();?>index.php/Admin/Daftar_Supervisor" class="btn btn-primary">Cancel</a>
            </div>
          </fieldset>
        </form>
      </div>
