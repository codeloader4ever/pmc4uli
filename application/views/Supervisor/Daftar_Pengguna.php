<div class="box span12">
	...
	<div class="box-content">
			...
			<a href="<?php echo base_url();?>index.php/Export_tbl_admin/export" class="btn btn-success" style="float:right;">
	<i class="icon-file icon-white"></i>Excel</a>		
			<a href="<?php echo base_url();?>index.php/Admin/TambahPengguna" class="btn btn-success" style="float:right;">
                        <i class="icon-plus icon-white"></i>Add</a>
						 
    <a href="<?php echo base_url();?>index.php/Admin/DaftarPengguna" class="btn btn-success" style="float:right;">
	...
	<thead>
		...
		<tr>
                    ...
                    <td class="center">
                        ...
                        <a class="btn btn-info" href='<?php echo base_url();?>index.php/Admin/UbahPengguna/<?php echo $row->id_admin;?>' title="Edit">
