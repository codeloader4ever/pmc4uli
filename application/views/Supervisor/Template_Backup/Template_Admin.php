...
<head>
	...
	<link href='<?php echo base_url();?>/Asset/<?php echo base_url();?>/Asset/css/elfinder.theme.css' rel='stylesheet'>
			...
			<div class="span2 main-menu-span">
				<div class="well nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a class="ajax-link" href="index.html"><i class="icon-home"></i><span class="hidden-tablet"> Beranda</span></a></li>
						<li class="nav-header hidden-tablet">Pengguna</li>
						<li><a class="ajax-link" href="table.html"><i class="icon-align-justify"></i><span class="hidden-tablet"> Tambah Pengguna</span></a></li>
						<li><a class="ajax-link" href="calendar.html"><i class="icon-calendar"></i><span class="hidden-tablet"> Daftar Pengguna</span></a></li>
						<li class="nav-header hidden-tablet">Kategori Artikel</li>
						<li><a class="ajax-link" href="grid.html"><i class="icon-th"></i><span class="hidden-tablet"> Tambah Kategori Artikel</span></a></li>
						<li><a class="ajax-link" href="file-manager.html"><i class="icon-folder-open"></i><span class="hidden-tablet"> Daftar Kategori Artikel</span></a></li>
						<li class="nav-header hidden-tablet">Artikel</li>
						<li><a href="tour.html"><i class="icon-globe"></i><span class="hidden-tablet"> Tambah Artikel</span></a></li>
						<li><a class="ajax-link" href="icon.html"><i class="icon-star"></i><span class="hidden-tablet"> Daftar Artikel</span></a></li>
						<li class="nav-header hidden-tablet">Level</li>
						<li><a href="error.html"><i class="icon-ban-circle"></i><span class="hidden-tablet"> Tambah Level</span></a></li>
						<li><a href="login.html"><i class="icon-lock"></i><span class="hidden-tablet"> Daftar Level</span></a></li>
					</ul>
				</div><!--/.well -->
			</div><!--/span-->
			<!-- left menu ends -->
