					...
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
                                                    <a class="ajax-link" href="<?php echo base_url(); ?>index.php/Admin/Daftar_Pengguna">
                                                        <i class="icon-user"></i>
                                                        <span class="hidden-tablet"> <font size="3">User</font>
                                                        </span>
                                                    </a>
                                                </li>
												
						<li>
                                                    <a class="ajax-link" href="<?php echo base_url(); ?>index.php/Admin/Daftar_Operator">
                                                        <i class="icon-user"></i>
                                                        <span class="hidden-tablet"> <font size="3">Operator</font>
                                                        </span>
                                                    </a>
                                                </li>
						<li class="nav-header hidden-tablet">|||</li>
