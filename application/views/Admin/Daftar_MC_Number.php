...
(isset($_POST["datepicker1"])) ? $datepicker1 = $_POST["datepicker1"] : $datepicker1=date('d/m/Y');
...
?>  
        ...
        <label class="control-label" for="typeahead"><font color="white">Date</font></label>
              <div class="controls">
                ...
                <font color="white">To &nbsp</font><input type="text"  id="datepicker1" name="datepicker1" value="<?php echo $datepicker1; ?>">
