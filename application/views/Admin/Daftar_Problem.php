<div class="box span12">
	...
	<h2><i class="icon-book"></i>Problem</h2>					
    </div>
	<div class="box-content">
            <form class="form-search" id="form_pencarian" name="form_pencarian" method="post" action="<?=base_url();?>index.php/Admin/Daftar_Problem">
            <h4>Search</h4>
    ...
    <a href="<?php echo base_url();?>index.php/Admin/DaftarProblem" class="btn btn-primary">Refresh</a>
	<a href="<?php echo base_url();?>index.php/Export_tbl_problem/export" class="btn btn-primary">Export To Excel</a>
    </form>
...
$no = $hal + 1;
if(count($DaftarProblem->result()) > 0) {
?>
	<thead>
            <tr>
        ...
        <tbody>
        <?php
        foreach($DaftarProblem->result() as $row){
        ?>
		<tr>
                    <td><?php echo $no; ?></td>
